...
if (userAge >= 18 && userAge <= 65){
    ...
    costReturn = `Minors get a 20% discount. The cost of your travel is ${travelFinalCost.toFixed(2)}€`;
} else{
    costReturn = `Old people get a 40% discount. The cost of your travel is ${travelFinalCost.toFixed(2)}€`;
}
